// Control LED RGB cu 3 potentiometre
// Grebanus Amalia-Teodora

// Fiecare potentiometru controleaza cate una dintre culori (R-Rosu, V-Verde, B-Albastru).
// Valorile sunt afisate în Serial Monitor.
...
void setup() {
  ...
  Serial.begin(9600); //viteza de transmisie
  Serial.println();
...
void loop() {
  ...
  //Afisare valori pe Serial Monitor
  Serial.print("Rosu: ");
  Serial.print(pwm_r);
  Serial.print("\tVerde: ");
  Serial.print(pwm_v);
  ...
  delay(intarziere_ms); // mica pauza pt. afisare
}
